...
// declare module 'type-assertions' {
//     export function IsTypeEqual<T, U>(): void;
//     export function IsTypeAssignable<T, U>(): void;
//     export type FirstArgument<T> = T extends (arg: infer A) => any ? A : never;
//     export function typeAssert<T>(value: T): void;
// }
// declarations/type-assertions/index.d.ts

// declare module 'type-assertions' {
//     export type IsTypeEqual<T, U> = boolean; // Defina o tipo conforme necessário
//     export function typeAssert<T>(value: T): void; // Defina a função conforme necessário
// }
// declare module 'type-assertions' {
//     export type IsTypeEqual<T, U> = T extends U ? (U extends T ? true : false) : false;
